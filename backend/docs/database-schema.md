...
- `catalog_source_refs`: private historical and review provenance
...
Migration `025_catalog_ownership.sql` archives legacy external identifiers and unresolved relations in private source history, keeps resolved relations as internal anime links, recalculates community metrics, and removes external-only identifiers and synchronization state from public catalog tables.
