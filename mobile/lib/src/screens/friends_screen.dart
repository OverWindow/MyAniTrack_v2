        ...
        child: AppContentWidth(
          child: CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(
                child: SizedBox(
                  key: const ValueKey('friend-search-keyboard-spacer'),
...
class _PublicCollectionScreenState
  ...
  int? _totalCount;
  CollectionQuery _filters = const CollectionQuery();
  bool _loading = true;
          ...
          child: SafeArea(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                ...
                SliverToBoxAdapter(
                  child: SizedBox(
                    key: const ValueKey('public-collection-keyboard-spacer'),
                    height: keyboardInset,
                  ),
                ),
              ],
  ...
  Future<void> _openFilters() async {
    final next = await showCupertinoModalPopup<CollectionQuery>(
      context: context,
      builder: (context) =>
          AppModalWidth(child: CollectionFilterSheet(initial: _filters)),
    );
    ...
    try {
      final page = await ref
          ...
          .collection(
            ...
            year: _filters.year,
            score: _filters.score,
            cancelToken: token,
          );
      if (!mounted || token.isCancelled || generation != _requestGeneration) {
        return;
      }
      setState(() {
        _items = page.items;
